...
if __name__ is "__main__":
    # Test case 1: Using
    # inputFile = '../../sounds/cello-phrase.wav', stdThsld = 10, minNoteDur = 0.1, winStable = 3, window = 'hamming', M = 1025, N = 2048, H = 256, f0et = 5.0, t = -100, minf0 = 310, maxf0 = 650,
    # the function segmentStableNotesRegions() should return 9  segments. Please use loadTestcases.load() to check the expected segment indexes in the output.
    #segments = segmentStableNotesRegions(inputFile = '../sms-tools/sounds/sax-phrase-short.wav', stdThsld=10, minNoteDur=0.1, M=1025, N=2048, H=256, f0et=5.0, minf0=310, maxf0=650)

    #loadTestcases.load()
    #if segments == 9:
    #    print(str(segments) + '==' + str(9))
    #else:
    #    print(str(segments) + '!=' + str(9))


    # Test case 2: Using
    # inputFile = '../../sounds/cello-phrase.wav', stdThsld = 20, minNoteDur = 0.5, winStable = 3, window = 'hamming', M = 1025, N = 2048, H = 256, f0et = 5.0, t = -100, minf0 = 310, maxf0 = 650,
    # the function segmentStableNotesRegions() should return 6 segments. Please use loadTestcases.load() to check the expected segment indexes in the output.
    # segments = segmentStableNotesRegions(inputFile='../sms-tools/sounds/sax-phrase-short.wav', stdThsld=20, minNoteDur=0.5, M=1025, N=2048, H=256, f0et=5.0, minf0=310, maxf0=650)

    # loadTestcases.load()
    #if segments == 6:
    #    print(str(segments) + '==' + str(6))
    #else:
    #    print(str(segments) + '!=' + str(6))

    # Test case 3: Using
    # inputFile = '../../sounds/sax-phrase-short.wav', stdThsld = 5, minNoteDur = 0.6, winStable = 3, window = 'hamming', M = 1025, N = 2048, H = 256, f0et = 5.0, t = -100, minf0 = 310, maxf0 = 650,
    # the function segmentStableNotesRegions() should return just one segment. Please use loadTestcases.load() to check the expected segment indexes in the output.
    segments = segmentStableNotesRegions(inputFile='../sms-tools/sounds/sax-phrase-short.wav', stdThsld=5, minNoteDur=0.6, winStable=3, M=1025, N=2048, H=256, f0et=5.0, minf0=310, maxf0=650)
    # loadTestcases.load()
    #if segments == 1:
    #    print(str(segments) + '==' + str(1))
    #else:
    #    print(str(segments) + '!=' + str(1))
