...
def estimateF0(inputFile='../sms-tools/sounds/cello-double-2.wav'):
    """
    ...
    # M = 3365  # window size
    # N = 8192  # fft size
    # f0et = 7  # error treshold
    # t = -100  # treshold f0 estimation

    # window = 'hann'  # window type
    # M = 2795  # window size
    # N = 4096  # fft size
    # f0et = 5  # error treshold
    # t = -60  # treshold f0 estimation
    ...
    minf0 = 120  # min f0 frequency
    maxf0 = 210  # max f0 frequency
    ...
    startFrame = np.int(np.floor(0.5*fs/H))
    endFrame = np.int(np.ceil(4.0*fs/H))
    f0[:startFrame] = 0
    f0[endFrame:] = 0
